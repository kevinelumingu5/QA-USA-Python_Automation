...
class UrbanRoutesPage:
    ...
    CARD_NUMBER_VALUE_LOCATOR = (By.XPATH, '//input[@id="number"]')
    ...
    def get_card_attribute(self):
        return self.driver.find_element(*self.CARD_NUMBER_INPUT_LOCATOR).text
    ...
    def get_message_attribute(self):
        return self.driver.find_element(*self.MESSAGE_DRIVER_INPUT_LOCATOR).text
